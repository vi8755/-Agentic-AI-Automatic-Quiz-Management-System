...
import {
    getStudentDescriptiveAssignmentPerformance,
} from "../../api/studentApi";

const StudentDescriptiveAssignmentPerformance = () => {
    ...
    useEffect(() => {
        const loadPerformance = async () => {
            try {
                ...
                const response =
                    await getStudentDescriptiveAssignmentPerformance(
                        assignmentId
                    );
                ...
                console.error(
                    "Failed to load descriptive assignment performance:",
                    error
                );

                toast.error(
                    error?.response?.data?.detail ||
                        "Unable to load assignment performance."
                );
            } finally {
                setLoading(false);
            }
            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-5 mb-6">
                    ...
                    <div className="bg-white rounded-2xl shadow-sm p-6">
                        ...
                        <h2 className="text-3xl font-bold text-gray-900 mt-2">
                            {data.my_score ?? "—"}
                            {data.my_score !== null &&
                                data.my_score !== undefined &&
                                ` / ${data.total_marks}`}
                        </h2>

                        <p className="text-purple-600 font-semibold mt-1">
                            {data.my_percentage !== null &&
                            data.my_percentage !== undefined
                                ? `${Number(
                                      data.my_percentage
                                  ).toFixed(2)}%`
                                : "Not evaluated"}
                ...
                <div className="bg-white rounded-2xl shadow-sm border mb-6">
                    <div className="px-6 py-5 border-b">
                        ...
                        <p className="text-sm text-gray-500 mt-1">
                            Ranked by percentage in this assignment.
                        </p>
                    </div>
                ...
                <div className="bg-white rounded-2xl shadow-sm border">
                    <div className="px-6 py-5 border-b">
                        ...
                        <p className="text-sm text-gray-500 mt-1">
                            Performance of students in your section for this assignment.
                        </p>
                    </div>
...
export default StudentDescriptiveAssignmentPerformance;
